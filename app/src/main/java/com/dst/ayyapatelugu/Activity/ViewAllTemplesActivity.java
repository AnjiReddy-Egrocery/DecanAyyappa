...
public class ViewAllTemplesActivity extends AppCompatActivity {
    ...
    private void informationDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ViewAllTemplesActivity.this);
        View dialogView = LayoutInflater.from(ViewAllTemplesActivity.this).inflate(R.layout.dialog_temples_information, null);
