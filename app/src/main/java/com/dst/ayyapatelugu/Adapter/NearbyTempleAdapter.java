...
public class NearbyTempleAdapter extends RecyclerView.Adapter<NearbyTempleAdapter.ViewHolder> {

    private Context context;
    private ArrayList<TempleMapDataResponse.Result> list;
    private OnTempleClickListener listener;

    public interface OnTempleClickListener {
        void onTempleClick(TempleMapDataResponse.Result item);
    }

    public NearbyTempleAdapter(Context context,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        TempleMapDataResponse.Result item = list.get(position);
